...
public class FeedbackAnalysisService {
	...
	public FeedbackAIResponse analyseData(String feedbackText, int rating) {
		String template = """
		...
		String categories = StringUtils
			.joinWithComma(categoryService.getAllCategories().stream().map(Category::getName).toArray(String[]::new));
