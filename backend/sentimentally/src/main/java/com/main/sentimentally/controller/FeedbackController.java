...
public class FeedbackController {
	...
	public FeedbackListDTO getAnalysedFeedback(@RequestParam(value = "categoryId", required = false) Integer categoryId,
		...
		List<Feedback> feedbackList = feedbackService.getFilteredFeedbacks(categoryId, propertyId, state, brandId, relativeDate);
	...
	public Feedback saveFeedBack(@RequestBody FeedbackDTO feedbackDTO){
		...
		FeedbackAIResponse feedbackAIResponse = feedbackAnalysisService.analyzeData(feedbackDTO.getFeedbackText(), feedbackDTO.getRating(), feedbackDTO.getPropertyId());
